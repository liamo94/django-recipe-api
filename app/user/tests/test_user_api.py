...
class PublicUserApiTests(TestCase):
    ...
    def test_password_too_short_error(self):
        """Test an error is returned if the password is < 5 characters"""
        payload = {
            "email": "test@example.com",
            "password": "pw",
            "name": "Test Name",
    ...
    def test_create_token_for_user(self):
        ...
        user_details = {
            "name": "Test Name",
            "email": "test@example.com",
            "password": "tets-user-password123",
        }
    ...
    def test_create_blank_password(self):
        """Test post with blank password fails"""
...
class PrivateUserApuTest(TestCase):
