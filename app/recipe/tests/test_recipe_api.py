...
class PrivateRecipeAPITests(TestCase):
    ...
    def test_delete_recipe(self):
        """Test successfully deleting recipe"""
        recipe = create_recipe(user=self.user)
    ...
    def test_create_recipe_with_existing_tags(self):
        ...
        existing_tag = "Indian"
        tag_indian = Tag.objects.create(user=self.user, name=existing_tag)
        payload = {
            "title": "Pongal",
            "time_minutes": 20,
            "price": Decimal("7.50"),
            "tags": [{"name": existing_tag}, {"name": "Breakfast"}],
        }
    ...
    def test_create_tag_on_update(self):
        ...
        self.assertTrue(new_tag, recipe.tags.all())

    def test_update_recipe_assign_tag(self):
        """Test assigning the existing tag when updating a recipe"""
    ...
    def test_create_recipe_with_existing_ingredients(self):
        ...
        ingredient = Ingredient.objects.create(user=self.user, name=existing_ingredient)
        payload = {
            "title": "Thai Prawn curry",
            "time_minutes": 20,
            "price": Decimal("7.50"),
    ...
    def test_update_recipe_assign_ingredient(self):
        ...
        ingredient_sauce = Ingredient.objects.create(user=self.user, name="Sauce")
        recipe = create_recipe(user=self.user)
    ...
    def test_filter_by_tags(self):
        ...
        r2 = create_recipe(user=self.user, title="Tomato soup")
    ...
    def test_filter_by_ingredients(self):
        ...
        in2 = Ingredient.objects.create(user=self.user, name="Tomato")
        r1.ingredients.add(in1)
        r2.ingredients.add(in2)
        r3 = create_recipe(user=self.user, title="Fruit salad")
